...
class About extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    const params = {
      ...
      url: "corporate/about/put",
    };

    API.request(params).then((res) => {
        const result = res.data;
        if(result.success){
            swal('Başarılı', 'Hakkımızda güncellendi !', 'success');
        }else{
            swal('Başarısız', 'Hakkımızda güncellenemedi !', 'error');
        }
    })
    .catch((err) => {
        console.log(err);
              ...
              <div className="col-12 col-lg-6 mt-3">
                <div className="card category-form">
                  <div className="card-header">
                    <h4 className="card-title">Hakkımızda Güncelle</h4>
                  </div>
